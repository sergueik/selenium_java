...
public class ProcessInfo {
	...
	public ProcessInfo(String pid, String time, String name, String user,
			String virtualMemory, String physicalMemory, String cpuUsage,
			String startTime, String priority, String command) {
		this.pid = pid;
		this.time = time;
		this.name = name;
		this.user = user;
	...
	public boolean equals(Object o) {
		...
		// false;
		// if (virtualMemory != null ? !virtualMemory.equals(that.virtualMemory) :
		// that.virtualMemory != null)
		// return false;
		// if (physicalMemory != null ? !physicalMemory.equals(that.physicalMemory)
		// : that.physicalMemory != null)
		// return false;
		// if (cpuUsage != null ? !cpuUsage.equals(that.cpuUsage) : that.cpuUsage !=
		// null) return false;
	...
	public int hashCode() {
		...
		// result = 31 * result + (user != null ? user.hashCode() : 0) //TODO:
		// return this to equals and hashcode after getProcessesOwner refactoring
		// result = 31 * result + (virtualMemory != null ? virtualMemory.hashCode()
		// : 0);
		// result = 31 * result + (physicalMemory != null ?
		// physicalMemory.hashCode() : 0);
