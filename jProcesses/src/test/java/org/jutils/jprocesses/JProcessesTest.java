...
public class JProcessesTest {
	...
	public void testGetProcessList() {
		...
		List<ProcessInfo> processesList = JProcesses.get().fastMode()
				.listProcesses();
	...
	public void testGetProcessListByName() {
		System.out
				.println("===============Testing getProcessList by name============");
		...
		List<ProcessInfo> processesList = JProcesses
				.getProcessList(processToSearch);
		...
		assertTrue(
				"Manually list differs from search founded " + processesListFound.size()
						+ " instead of " + processesList.size(),
				processesList.size() == processesListFound.size());

		System.out
				.println("===============End test getProcessList by name============");
	}
