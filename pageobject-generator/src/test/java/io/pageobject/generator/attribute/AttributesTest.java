...
public class AttributesTest {
	...
	public void handlesAngular1Attributes() throws Exception {
		String[] variants = { "ng-model", "data-ng-model", "data_ng-model",
				"data:ng-model", "x-ng-model", "x_ng-model", "x:ng-model", "ng_model",
				"data-ng_model", "data_ng_model", "data:ng_model", "x-ng_model",
				"x_ng-model", "x:ng-model", "ng:model", "data-ng:model",
				"data_ng:model", "data:ng:model", "x-ng:model", "x_ng:model",
				"x:ng:model" };
	...
	public void handlesEventBindings() throws Exception {
		...
		assertThat(getAngular2EventBindingAttribute(element, "click"))
				.isEqualTo("save()");
		...
		assertThat(getAngular2EventBindingAttribute(element2, "click"))
				.isEqualTo("save()");
	}
}