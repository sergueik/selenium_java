...
public class GeneratorContext {
	...
	protected Multimap<LocatorSources, String> usedLocators = HashMultimap
			.create();

	public GeneratorContext(Document document, String source,
	...
	public void pushNgRepeat(Element element, String repeaterExpression) {
		locatorPartGenerators
				.push(new NgRepeatLocatorPartGenerator(element, repeaterExpression));
	}
	...
	public void pushLocatorPartGenerator(
			LocatorPartGenerator locatorPartGenerator) {
	...
	public Element getLastRepeaterElement() {
		return locatorPartGenerators.get(locatorPartGenerators.size() - 2)
				.getElement();
	}
	...
	public boolean isLocatorAvailable(LocatorSources locatorSource,
			String value) {
