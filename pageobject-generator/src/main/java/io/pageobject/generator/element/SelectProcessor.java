...
public class SelectProcessor extends AbstractElementProcessor {
	...
	protected LocatorSources[] getElementLocatorCandidates(
		...
		return new LocatorSources[] { LocatorSources.NG_MODEL,
				LocatorSources.NG_OPTIONS, LocatorSources.ID, LocatorSources.NAME,
				LocatorSources.CSS };
	}
	...
	protected List<String> getTemplates(GeneratorContext context,
		...
		return newArrayList(SELECT_BY_PARTIAL_TEXT, SELECT_BY_TEXT, SELECT_BY_VALUE,
				ASSERTION_SELECTED_BY_PARTIAL_TEXT, ASSERTION_SELECTED_BY_TEXT,
				ASSERTION_SELECTED_BY_VALUE, ASSERTION_VISIBILITY, ASSERTION_ENABLED,
				ASSERTION_HAS_CLASS);
	}
}
