...
public enum NameSources {
	...
	NG_REPEAT {
		...
		public String extractName(Element element) {
			...
			return isNullOrEmpty(repeatExpression) ? null
					: extractNameFromRepeater(repeatExpression);
		}
	},
	NG_FOR {
		@Override
	...
	NG_BIND_TEMPLATE {
		...
		public String extractName(Element element) {
			return getFirstExpression(
					extractAttributeName(element, HtmlAttributes.NG_BIND_TEMPLATE));
		}
	},
	EXPRESSION_TEXT {
		@Override
	...
	private static String extractAttributeName(Element element,
