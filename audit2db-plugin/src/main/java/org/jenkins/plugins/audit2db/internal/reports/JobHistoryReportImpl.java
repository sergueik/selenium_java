 ...
 */
@Extension
public class JobHistoryReportImpl extends AbstractDbAuditReport
	...
	public Map<String, List<BuildDetails>> getProjectExecutions(
		...
		final List<String> projectNames = getRepository()
				.getProjectNames(jenkinsHost, jobName, startDate, endDate);
		for (final String projectName : projectNames) {
			final List<BuildDetails> buildDetails = getRepository()
					.getBuildDetails(jenkinsHost, projectName, startDate, endDate);
