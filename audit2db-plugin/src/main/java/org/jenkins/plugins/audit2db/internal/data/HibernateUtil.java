...
public class HibernateUtil {
	...
	private static Configuration getConfig(final Properties extraProperties)
	...
	public static SessionFactory getSessionFactory(
		...
		if (_sessionFactory == null) {
			try {
				...
				LOGGER.log(Level.SEVERE, Messages.HibernateUtil_FailedSessionFactory(),
						e);
	...
	public static Properties getExtraProperties(final String driverClass,
			final String driverUrl, final String username, final String password) {
	...
	public static String getSchemaDdl(final String driverClass,
			final String driverUrl, final String username, final String password)
			throws IOException {
		String retval = null;
		final Properties props = getExtraProperties(driverClass, driverUrl,
				username, password);
		final SessionFactory sessionFactory = getSessionFactory(props);
		final String dialect = ((SessionFactoryImplementor) sessionFactory)
				.getDialect().toString();
		...
		retval = String.format(Messages.HibernateUtil_GeneratedNote(), dialect,
				scanner.next());
		tempDdlFile.delete();
