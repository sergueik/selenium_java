...
public class WhenRunningJobsHistoryReport extends HudsonTestCase {
	private static final Logger LOGGER = Logger
			.getLogger(WhenRunningJobsHistoryReport.class.getName());
	...
	public void testShouldDisplayNoRecordsForNonMatchingSelection() {
		final JobHistoryReport report = TestUtils
				.getReportExtension(JobHistoryReport.class);

		final BuildDetailsHibernateRepository repository = (BuildDetailsHibernateRepository) report
				.getRepository();
