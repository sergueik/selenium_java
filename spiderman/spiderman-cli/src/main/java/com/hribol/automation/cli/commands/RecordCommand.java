...
public class RecordCommand implements Command {
	...
	public RecordCommand(String pathToChromedriver, String pathToJSInjectionFile,
			String baseUrl, String ouputFile) {
	...
	@Override
	public void run() {
		RecordBrowserBase recordBrowserBase = new ChromeRecordBrowser(
				pathToChromedriver, pathToJSInjectionFile);
		try {
