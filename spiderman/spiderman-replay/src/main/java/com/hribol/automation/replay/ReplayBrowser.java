...
public class ReplayBrowser {
	...
	public AutomationResult replay(TestScenario testScenario,
	...
	public AutomationResult replayOnScreen(TestScenario testScenario,
			WebDriverActionExecution webDriverActionExecution, String screen)
			throws IOException, InterruptedException, URISyntaxException {
	...
	public AutomationResult replay(String pathToSerializedTest,
		...
		TestScenario testScenario = testScenarioFactory
				.createFromFile(applicationActionFactory, pathToSerializedTest);
