 ...
 */
public class DefaultApplicationActionFactory
		implements ApplicationActionFactory {
	...
	public DefaultApplicationActionFactory(String url,
		...
		this(url, applicationConfiguration,
	...
	public DefaultApplicationActionFactory(String url,
		...
		for (ApplicationActionConfiguration applicationActionConfiguration : applicationConfiguration
				.getApplicationActionConfigurationList()) {
			nameToConfiguration.put(applicationActionConfiguration.getName(),
					applicationActionConfiguration);
		}

		this.initialPageLoadingEventName = "INITIAL_PAGE_LOAD_"
	...
	public ApplicationAction create(Map<String, String> testCaseStep) {
		...
		ApplicationActionConfiguration applicationActionConfiguration = nameToConfiguration
				.get(name);
		return testCaseToApplicationActionConverter
