...
public class ApplicationActionConfiguration {
	...
	public void setConditionBeforeExecution(
			WebDriverActionConfiguration conditionBeforeExecution) {
	...
	public void setConditionAfterExecution(
			WebDriverActionConfiguration conditionAfterExecution) {
