...
public class ApplicationActionConfigurationTest {
	...
	public void applicationActionConfigurationSettersAndGetters() {
		String name = "name";
		WebDriverActionConfiguration conditionBeforeExecution = mock(
				WebDriverActionConfiguration.class);
		WebDriverActionConfiguration webdriverAction = mock(
				WebDriverActionConfiguration.class);
		WebDriverActionConfiguration conditionAfterExecution = mock(
				WebDriverActionConfiguration.class);
