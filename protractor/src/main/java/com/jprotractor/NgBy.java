...
import com.jprotractor.scripts.FindRepeaterSelectedOption;
...
public final class NgBy {
    ...
    public static By repeaterSelectedOption(final String repeat) {
        return new JavaScriptBy(new FindRepeaterSelectedOption(), repeat);
    }
}
