...
import static example.XLS.doesNotContainText;
...
public class ContainsTextTest {
	...
	public void canAssertThatXlsContainsText() throws IOException {
		XLS XLS = new XLS(Objects.requireNonNull(
				getClass().getClassLoader().getResource("statement.xls")));
		...
		try {
			...
			assertThat(expected.getMessage(),
					is("\nExpected: a XLS not containing text \"Выписка\""
							+ "\n     but: was \"" + System.getProperty("user.dir")
