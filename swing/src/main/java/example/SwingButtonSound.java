 ...
 */
public class SwingButtonSound extends JComponent {
	...
	// The main method just creates an SwingButtonSound in a Frame and displays it
	public static void main(String[] args) throws IOException,
			UnsupportedAudioFileException, LineUnavailableException,
			MidiUnavailableException, InvalidMidiDataException {
		SwingButtonSound player;
		...
		// Create a SwingButtonSound object to play the sound.
		player = new SwingButtonSound(file, ismidi);

		// Put it in a window and play it
		JFrame f = new JFrame("SwingButtonSound");
	...
	// Create an SwingButtonSound component for the specified file.
	public SwingButtonSound(File f, boolean isMidi) throws IOException,
			UnsupportedAudioFileException, LineUnavailableException,
			MidiUnavailableException, InvalidMidiDataException {
