...
public class Configuration extends AbstractDescribableImpl<Configuration> {
	...
	public static final class ConfigurationDescriptor extends
			Descriptor<Configuration> implements MasterCoverageRepository,
			SettingsRepository {
		...
		public boolean configure(StaplerRequest req, JSONObject formData)
			...
			personalAccessToken = StringUtils.trimToNull(formData
					.getString("personalAccessToken"));
			yellowThreshold = NumberUtils.toInt(
					formData.getString("yellowThreshold"), DEFAULT_YELLOW_THRESHOLD);
			greenThreshold = NumberUtils.toInt(formData.getString("greenThreshold"),
