...
public class ServiceRegistry {
	...
	public static MasterCoverageRepository getMasterCoverageRepository() {
		return masterCoverageRepository != null ? masterCoverageRepository
				: Configuration.DESCRIPTOR;
	}

	public static void setMasterCoverageRepository(
			MasterCoverageRepository masterCoverageRepository) {
	...
	public static SettingsRepository getSettingsRepository() {
		return settingsRepository != null ? settingsRepository
				: Configuration.DESCRIPTOR;
	}
	...
	public static PullRequestRepository getPullRequestRepository() {
		return pullRequestRepository != null ? pullRequestRepository
				: new GitHubPullRequestRepository();
	}

	public static void setPullRequestRepository(
