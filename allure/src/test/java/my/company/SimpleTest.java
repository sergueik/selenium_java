...
public class SimpleTest {
	...
	@Issues({ @Issue("ALR-123"), @Issue("ALR-456"), @Issue("ALR-789") })
	@TestCaseId("TMS-123")
	public void parametrizedTest(@Parameter String parameter1,
			@Parameter("Third Parameter Name") int parameter2, int parameters3) {
	...
	private byte[] getSampleFile(String fileName) throws IOException,
			URISyntaxException {
