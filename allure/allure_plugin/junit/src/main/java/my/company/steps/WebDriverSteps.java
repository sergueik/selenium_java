...
public class WebDriverSteps {
	...
	public void search(String text) {
		...
		// FluentWait will not compile with Selenium 3.x
		// new WebDriverWait(driver, 10).withMessage("Could not load results page")
		// .until(mainContainLoaded());
		// [ERROR] method until in class
		// org.openqa.selenium.support.ui.FluentWait<T> cannot be applied to given
		// types;
		// [ERROR] required: java.util.function.Function<? super
		// org.openqa.selenium.WebDriver,V>
		// [ERROR] found:
		// com.google.common.base.Predicate<org.openqa.selenium.WebDriver>
		// [ERROR] reason: cannot infer type-variable(s) V
		// [ERROR] (argument mismatch;
		// com.google.common.base.Predicate<org.openqa.selenium.WebDriver> cannot be
