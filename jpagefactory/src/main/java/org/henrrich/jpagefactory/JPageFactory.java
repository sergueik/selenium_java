...
public class JPageFactory {
	...
	public static void initElements(SearchContext searchContext, Channel channel,
			Object page) {
		PageFactory.initElements(
				new JPageFactoryFieldDecorator(
						new JPageFactoryElementLocatorFactory(searchContext, channel)),
				page);
	}
	...
	public static void initMobileElements(SearchContext searchContext,
			Object page) {
