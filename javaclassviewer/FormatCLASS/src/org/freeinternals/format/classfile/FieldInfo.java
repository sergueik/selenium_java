 ...
 * @author Amos Shi
 * @since JDK 6.0
 * @see <a href="http://www.freeinternals.org/mirror/java.sun.com/vmspec.2nded/ClassFile.doc.html#2877">
 * VM Spec: Fields
 * </a>
 */
public class FieldInfo extends ClassComponent {
    ...
    // Get extracted data
    /**
     * Generate the modifier of a {@code Field} from the {@code access_flags} value.
     *
