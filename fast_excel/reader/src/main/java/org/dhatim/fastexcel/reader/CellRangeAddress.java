...
public final class CellRangeAddress {
	...
	public CellRangeAddress(int firstRow, int lastRow, int firstCol,
			int lastCol) {
		...
		if (lastRow < firstRow || lastCol < firstCol) {
			throw new IllegalArgumentException(
					"Invalid cell range, having lastRow < firstRow || lastCol < firstCol, "
							+ "had rows " + lastRow + " >= " + firstRow + " or cells "
							+ lastCol + " >= " + firstCol);
		}
	}
	...
	public boolean isInRange(int row, int column) {
		return firstRow <= row && row <= lastRow && firstCol <= column
				&& column <= lastCol;
	}
	...
	public boolean equals(Object obj) {
		...
		return firstRow == other.firstRow && firstCol == other.firstCol
	...
	public static CellRangeAddress valueOf(String ref) {
		...
		return new CellRangeAddress(a.getRow(), b.getRow(), a.getColumn(),
				b.getColumn());
	}
