...
class SimpleXmlReader implements Closeable {
	...
	public SimpleXmlReader(XMLInputFactory factory, InputStream inputStream)
	...
	public void forEach(String startChildElement, String untilEndElement,
			Consumer<SimpleXmlReader> consumer) throws XMLStreamException {
		while (goTo(() -> isStartElement(startChildElement)
				|| isEndElement(untilEndElement))) {
