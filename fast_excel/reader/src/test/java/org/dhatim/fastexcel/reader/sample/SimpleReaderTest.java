...
public class SimpleReaderTest {
	...
	private static final Object[][] VALUES = { { 1, "Lorem", date(2018, 1, 1) },
			{ 2, "ipsum", date(2018, 1, 2) }, { 3, "dolor", date(2018, 1, 3) },
			{ 4, "sit", date(2018, 1, 4) }, { 5, "amet", date(2018, 1, 5) },
			{ 6, "consectetur", date(2018, 1, 6) },
			{ 7, "adipiscing", date(2018, 1, 7) }, { 8, "elit", date(2018, 1, 8) },
			{ 9, "Ut", date(2018, 1, 9) }, { 10, "nec", date(2018, 1, 10) }, };

	@Test
	public void test() throws IOException {
		try (InputStream is = openResource("/xlsx/simple.xlsx");
