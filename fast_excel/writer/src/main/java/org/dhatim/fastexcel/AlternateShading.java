...
class AlternateShading {
	...
	void write(Writer w) throws IOException {
		w.append("<conditionalFormatting sqref=\"").append(range.toString())
				.append("\"><cfRule type=\"expression\" dxfId=\"").append(fill).append(
						"\" priority=\"1\"><formula>MOD(ROW(),2)</formula></cfRule></conditionalFormatting>");
	}
}
