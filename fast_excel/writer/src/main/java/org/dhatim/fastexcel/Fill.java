...
class Fill {
	...
	public boolean equals(Object obj) {
		...
		if (obj != null && obj.getClass() == this.getClass()) {
			Fill other = (Fill) obj;
			result = Objects.equals(patternType, other.patternType)
					&& Objects.equals(colorRgb, other.colorRgb)
	...
	void write(Writer w) throws IOException {
		w.append("<fill><patternFill patternType=\"").append(patternType)
				.append('\"');
		if (colorRgb == null) {
			w.append("/>");
		} else {
			w.append("><").append(fg ? "fg" : "bg").append("Color rgb=\"")
					.append(colorRgb).append("\"/></patternFill>");
		}
		w.append("</fill>");
	}
}
