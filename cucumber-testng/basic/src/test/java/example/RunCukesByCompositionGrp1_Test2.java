...
public class RunCukesByCompositionGrp1_Test2 {
	...
	private final Class<? extends RunCukesByCompositionGrp1_Test2> testClass = this
			.getClass();
	 ...
	 */
	@Test(groups = "examples-testng", description = "Example invoke Cucumber through TestNGCucumberRunner")
