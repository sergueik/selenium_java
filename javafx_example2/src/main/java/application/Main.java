/**
 *  GUI für die Pubs Datenbank mit JDBC
 *  
 *  @author Christian Pojoni
 *  @see http://code.makery.ch/library/javafx-8-tutorial
 */
...
public class Main extends Application {
	...
	//private ObservableList<Person> movieData = FXCollections.observableArrayList();
	...
	public void showUserDataView() throws IOException {
		...
		// lade userdataview
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(Main.class.getResource("view/UserDataView.fxml"));
