...
public class ByAngularRepeaterCell extends ByAngular.BaseBy {
	...
	public static class NgFindByBuilder extends AbstractFindByBuilder {
		...
		public By buildIt(final Object annotation, Field field) {
			...
			return new ByAngularRepeaterCell(findBy.rootSelector(), findBy.repeater(),
					findBy.exact(), findBy.row(), findBy.column());
		}
	}

	public ByAngularRepeaterCell(String rootSelector, String repeater,
			boolean exact, int row, String column) {
		super(rootSelector);
	...
	protected Object getObject(SearchContext context,
		...
		return javascriptExecutor
				.executeScript("var using = arguments[0] || document;\n"
						...
						+ "var index = " + row + ";\n" + "var binding = '" + column + "';\n"
						+ "var exact = " + exact + ";\n" + "\n"
						+ ByAngular.functions.get("findRepeaterElement"), context);
	}
