...
public class ByAngularRepeaterColumn extends ByAngular.BaseBy {
	...
	public static class NgFindByBuilder extends AbstractFindByBuilder {
		...
		public By buildIt(final Object annotation, Field field) {
			...
			return new ByAngularRepeaterColumn(findBy.rootSelector(),
					findBy.repeater(), findBy.exact(), findBy.column());
		}
	}

	public ByAngularRepeaterColumn(String rootSelector, String repeater,
			boolean exact, String column) {
		super(rootSelector);
	...
	public String toString() {
		return (exact ? "exactR" : "r") + "epeater(" + repeater + ").column("
				+ column + ")";
	}
