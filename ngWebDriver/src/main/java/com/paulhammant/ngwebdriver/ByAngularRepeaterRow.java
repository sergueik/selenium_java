...
public class ByAngularRepeaterRow extends ByAngular.BaseBy {
	...
	public static class NgFindByBuilder extends AbstractFindByBuilder {
		...
		public By buildIt(final Object annotation, Field field) {
			...
			return new ByAngularRepeaterRow(findBy.rootSelector(), findBy.repeater(),
					findBy.exact(), findBy.row());
		}
	}

	public ByAngularRepeaterRow(String rootSelector, String repeater,
			boolean exact, int row) {
		super(rootSelector);
	...
	public ByAngularRepeaterCell column(String column) {
		return new ByAngularRepeaterCell(rootSelector, repeater, exact, row,
				column);
	}
	...
	protected Object getObject(SearchContext context,
		...
		return javascriptExecutor
				.executeScript("var using = arguments[0] || document;\n"
						...
						+ "var index = " + row + ";\n" + "var exact = " + exact + ";\n"
						+ "\n" + ByAngular.functions.get("findRepeaterRows"), context);
	}
