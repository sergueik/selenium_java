...
public interface Pdh extends StdCallLibrary {
    ...
    int PDH_INSUFFICIENT_BUFFER = 0xC0000BC2;
    ...
    // TODO: need PdhGetFormattedCounterValue 
    int PdhGetFormattedCounterValue(HANDLE hCounter, DWORDByReference lpdwType, PDH_RAW_COUNTER pValue);
