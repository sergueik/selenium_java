...
public class MessageBuilder {
	...
	public static String buildGeoLocationMessage(int id, double latitude,
		...
		/* 
		 return String.format("{\"id\":%s,\"method\":\"Emulation.setGeolocationOverride\"," +
		  "\"params\":{\"latitude\":%s,\"longitude\":%s,\"accuracy\":100}}",id,latitude,longitude);
		 */
	}
	...
	public static String buildGetContinueInterceptedRequestMessage(int id,
		...
		/*		 
			return String.format(
				...
				id, interceptionId, new String(Base64.encodeBase64(rawResponse.getBytes())));
		 */
	}
	...
	public static String buildServiceWorkerInspectMessage(int id,
		...
		return buildMessage(id, method, params);
		/*
		return String.format( "{\"id\":%s,\"method\":\"ServiceWorker.inspectWorker\"," +
	...
	public static String buildSendPushNotificationMessage(int id, String origin,
		...
		return buildMessage(id, method, params);
		/*
		return String.format( "{\"id\":%s,\"method\":\"ServiceWorker.deliverPushMessage\","+
	...
	public static String buildObserveBackgroundServiceMessage(int id) {
		...
		return buildMessage(id, method, params);
		/*
		return String.format("{\"id\":%s,\"method\":\"BackgroundService.startObserving\"," + 
	...
	public static String buildRequestInterceptorEnabledMessage() {
		...
		return buildMessage(id, method, params);
		/*
		return String.format( "{\"id\":4, \"method\":\"Network.setRequestInterception\"," + 
			"\"params\":{\"enabled\":true}}");
		*/
	}
