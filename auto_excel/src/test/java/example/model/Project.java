...
public class Project {
	...
	public Project(String projName, BigDecimal basalArea, BigDecimal buildingArea, BigDecimal insideArea,
			BigDecimal saleArea, BigDecimal availablePrice, BigDecimal availableAmount) {
