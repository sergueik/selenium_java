...
public class Contract {
	...
	public Contract(String contractCode, String contractProperties, Date signDate, BigDecimal contractAmount,
			BigDecimal settlementAmount, BigDecimal sumPayAmount) {
