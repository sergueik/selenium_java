...
public class DataProviderTransformer implements IAnnotationTransformer {
	...
	@DataProvider
	public Iterator<Object[]> supplySeqData(final ITestContext context,
			final Method testMethod) {
		return transform(context, testMethod);
	}

	@DataProvider(parallel = true)
	public Iterator<Object[]> supplyParallelData(final ITestContext context,
			final Method testMethod) {
		return transform(context, testMethod);
	}
