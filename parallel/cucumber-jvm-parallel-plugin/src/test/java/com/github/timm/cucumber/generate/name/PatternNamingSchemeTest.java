...
public class PatternNamingSchemeTest {
	...
	public static Collection<Object[]> params() {
		...
		{ "{f}", "FeatureFile" }, { "{c}", "01" }, { "{f}{c}", "FeatureFile01" },
				{ "Foo", "Foo" },
	...
	public void setupMocks() {
		...
		given(mockFileNamingScheme.generate(any(String.class))).willReturn(
				"FeatureFile");
	}

	@Test
	public void generateFilename() {
		final PatternNamingScheme namingScheme = new PatternNamingScheme(pattern,
				mockCounter, mockFileNamingScheme);
	...
	public void patternIsNull() {
		final PatternNamingScheme namingScheme = new PatternNamingScheme(null,
				mockCounter, mockFileNamingScheme);
