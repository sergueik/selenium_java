...
/**
 * Copyright (c) 2008-2014 The Cucumber Organisation Adapted from Cucumbers
 * RuntimeOptionsTest
 */
public class RuntimeOptionsTest {
	...
	public void assigns_filters_from_tags() {
		final RuntimeOptions options = new RuntimeOptions(
				"--tags @keep_this somewhere_else:3");
	...
	public void parses_plugin() {
		final RuntimeOptions options = new RuntimeOptions(asList("--plugin",
				"html:some/dir", "--glue", "somewhere"));
	...
	public void parses_multiple_plugins() {
		final RuntimeOptions options = new RuntimeOptions(asList("--plugin",
				"html:some/dir", "--plugin", "pretty", "--glue", "somewhere"));
	...
	public void assigns_strict() {
		final RuntimeOptions options = new RuntimeOptions(asList("--strict",
				"--glue", "somewhere"));
	...
	public void assigns_strict_short() {
		final RuntimeOptions options = new RuntimeOptions(asList("-s", "--glue",
				"somewhere"));
		assertTrue(options.isStrict());
	}
	...
	public void default_strict() {
		final RuntimeOptions options = new RuntimeOptions(asList("--glue",
				"somewhere"));
	...
	public void unknown_options_are_ignored() {
		try {
			new RuntimeOptions(asList("-concreteUnsupportedOption", "somewhere",
					"somewhere_else"));
	...
	public void shouldParseTagsWhenMultipleWhitespaceBetweenOptionArgs() {
		final RuntimeOptions parser = new RuntimeOptions(
				CUCUMBER_OPTS_WITH_MULTI_WHITESPACE_BETWEEN_ARGS);
