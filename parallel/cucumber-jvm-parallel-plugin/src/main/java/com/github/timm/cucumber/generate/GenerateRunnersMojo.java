...
public class GenerateRunnersMojo extends AbstractMojo implements
		FileGeneratorConfig {
	...
	public void execute() throws MojoExecutionException {
		...
		final ClassNamingSchemeFactory factory = new ClassNamingSchemeFactory(
				new OneUpCounter());
		final ClassNamingScheme classNamingScheme = factory.create(namingScheme,
				namingPattern);
	...
	/**
	 * Overrides the parameters with cucumber.options if they have been specified.
