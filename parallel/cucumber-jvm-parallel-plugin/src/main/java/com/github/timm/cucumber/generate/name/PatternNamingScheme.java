...
public class PatternNamingScheme implements ClassNamingScheme {
	 ...
	 *          The pattern to use.
	 * @param counter
	 *          Counter to generate one up numbers
	 * @param featureFileNamingScheme
	 *          Naming scheme to use for '{f}' placeholder
	 */
	 ...
	 *          The feature file to generate a class name for
	 * @return A class name based on the required pattern.
	 */
	public String generate(final String featureFileName) {

		String className = pattern.replace("{f}",
				featureFileNamingScheme.generate(featureFileName));
