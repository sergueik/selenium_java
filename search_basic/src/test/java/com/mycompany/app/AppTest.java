...
public class AppTest // extends BaseTest
{
	...
	public void setupBeforeSuite(ITestContext context)
		...
		selenium_browser = context.getCurrentXmlTest()
				.getParameter("selenium.browser");
		...
		if (selenium_run.compareToIgnoreCase("remote") == 0) {
			...
			if (selenium_browser.compareToIgnoreCase("chrome") == 0) {
				...
				try {
					System.err.println("Launching remote selenium instance: " + "http://"
							+ selenium_host + ":" + selenium_port + "/wd/hub");
					driver = new RemoteWebDriver(
							new URL(
									"http://" + selenium_host + ":" + selenium_port + "/wd/hub"),
							capabilities);
