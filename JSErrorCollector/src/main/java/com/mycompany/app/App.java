...
public class App {
  ...
  static WebDriver driver;
	...
	private static JavaScriptError errorSimpleHtml = new JavaScriptError("TypeError: null has no properties", urlSimpleHtml, 9, null);

  public static void main(String[] args) throws InterruptedException,java.io.IOException {
    List<JavaScriptError> expectedErrors =  Arrays.asList(errorSimpleHtml);
    System.out.println(System.getProperty("user.dir"));
    File netExport = new File(System.getProperty("user.dir") + "/src/main/resources/firefox");
  ...
  private static String getResource(final String string) {
		String resource = App.class.getClassLoader().getResource(string).toExternalForm();
